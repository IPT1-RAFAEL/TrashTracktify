...
// Initialize marker variable but don't add it to the map yet
let marker = null;

// Listen for live updates from index.js
socket.on("location-update", (data) => {
  ...
  console.log(`🛰 Synced position: ${latitude}, ${longitude}`);
});
...
// Loop through polygons and add them to map
